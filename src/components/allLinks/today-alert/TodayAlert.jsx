...
const TodayAlert = () => {
  return (
    <div className="min-h-full p-4 bg-[#dcf3ed]">
      {/* Sticky Header: filter, sort, search */}
      <div className="sticky top-0 z-10 bg-[#b5dad0]  rounded-[10px] border-b-2 border-white/40 items-center justify-center  py-4 p-2 flex flex-col sm:flex-row sm:items-center sm:gap-9 gap-3 shadow-md">
        {/* Filter */}
        ...
        <div className="w-full sm:w-auto">
          <input
            ...
            className="w-full sm:w-[400px] px-4 py-2 outline-0 border-2 rounded-2xl border-gray-400 text-[14px] sm:text-[16px]"
          />
        </div>
      </div>
